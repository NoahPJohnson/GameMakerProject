...
if (place_meeting(x+hspd,y,obj_boundary) || place_meeting(x+hspd,y,obj_enemy) || place_meeting(x+hspd,y,obj_player))
   {
    ...
    if (place_meeting(x+hspd,y,obj_enemy))
       {
        player_collision = instance_place(x+hspd,y, obj_enemy);
        //player_collision.x += hspd;
        ...
        with (player_collision)
             {
              if (!place_meeting(x + reference_hspd,y,obj_boundary) && !place_meeting(x + reference_hspd,y,obj_boss_main_body) && !place_meeting(x + reference_hspd,y,obj_boss_claw) && !place_meeting(x + reference_hspd,y,obj_player))
                 {
                  x += reference_hspd;
                 }
              else
...
if (place_meeting(x,y-1,obj_enemy))
       {
        ...
        with (player_collision)
             {
              if (!place_meeting(x + reference_hspd,y,obj_boundary) && !place_meeting(x+reference_hspd,y,obj_player))
                 {
                  x += reference_hspd;
                 }
              else
...
if (place_meeting(x,y+vspd,obj_enemy))
   {
    ...
    with (player_collision)
         {
          if (!place_meeting(x,y + reference_vspd,obj_boundary) && !place_meeting(x,y + reference_vspd,obj_player))
             {
              y += reference_vspd;
             }
          else
...
if (place_meeting(x,y-1,obj_player))
...
else if (place_meeting(x,y-1,obj_enemy))
   {
    ...
    with (player_collision)
         {
          if (place_meeting(x,y + reference_vspd,obj_player))
             { 
              reference_vspd = 0;
             }
          y += reference_vspd;
